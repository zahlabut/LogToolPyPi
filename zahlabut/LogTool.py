    ...
    def analyze_log(self, last_line_date):
        ...
        for block in list_of_blocks:
            ...
            if block_date['Error']==None:
                ...
                block+="\n*** zahlabut --> this block is missing timestamp, therefore could be irrelevant to your" \
                      " time range! ***"
            if date>time_grep:
...
def load_conf_file(conf_file):
    try:
        ...
        LogTool.print_in_color('Exception raised in "load_conf_file" function, failed to load '+conf_file+'!!!','red')
        LogTool.print_in_color(str(e), 'red')
